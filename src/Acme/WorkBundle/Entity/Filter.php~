...
class Filter
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Acme\UserBundle\Entity\User", inversedBy="filters")
    * @ORM\JoinColumn(name="user_id", referencedColumnName="id")
    */
    protected $user;

    /**
    * @ORM\ManyToOne(targetEntity="Location", inversedBy="filters")
    * @ORM\JoinColumn(name="location_id", referencedColumnName="id")
    */
    protected $location;

    /**
    * @ORM\ManyToMany(targetEntity="Language", inversedBy="filters")
    * @ORM\JoinTable(name="filters_languages")
    * @Count(min = 1, minMessage = "At least one language must be selected")
    **/
    private $languages;

    /**
     * @ORM\ManyToOne(targetEntity="Salary", inversedBy="filter")
